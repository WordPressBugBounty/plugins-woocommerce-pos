...
return array(
    ...
    'WCPOS\\WooCommercePOS\\API\\Cashier' => $baseDir . '/includes/API/Cashier.php',
    'WCPOS\\WooCommercePOS\\API\\Checkout_Controller' => $baseDir . '/includes/API/Checkout_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Coupons_Controller' => $baseDir . '/includes/API/Coupons_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Customers_Controller' => $baseDir . '/includes/API/Customers_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Data_Order_Statuses_Controller' => $baseDir . '/includes/API/Data_Order_Statuses_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Extensions' => $baseDir . '/includes/API/Extensions.php',
    'WCPOS\\WooCommercePOS\\API\\Gateway_Bootstrap_Controller' => $baseDir . '/includes/API/Gateway_Bootstrap_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Logs' => $baseDir . '/includes/API/Logs.php',
    ...
    'WCPOS\\WooCommercePOS\\API\\Print_Jobs_Controller' => $baseDir . '/includes/API/Print_Jobs_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Product_Brands_Controller' => $baseDir . '/includes/API/Product_Brands_Controller.php',
    ...
    'WCPOS\\WooCommercePOS\\API\\Raw_Response' => $baseDir . '/includes/API/Raw_Response.php',
    'WCPOS\\WooCommercePOS\\API\\Receipts_Controller' => $baseDir . '/includes/API/Receipts_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Settings' => $baseDir . '/includes/API/Settings.php',
    'WCPOS\\WooCommercePOS\\API\\Shipping_Methods_Controller' => $baseDir . '/includes/API/Shipping_Methods_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Stores' => $baseDir . '/includes/API/Stores.php',
    'WCPOS\\WooCommercePOS\\API\\Tax_Classes_Controller' => $baseDir . '/includes/API/Tax_Classes_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Taxes_Controller' => $baseDir . '/includes/API/Taxes_Controller.php',
    'WCPOS\\WooCommercePOS\\API\\Templates_Controller' => $baseDir . '/includes/API/Templates_Controller.php',
    ...
    'WCPOS\\WooCommercePOS\\Templates\\Adapters\\Starprnt_Output_Adapter' => $baseDir . '/includes/Templates/Adapters/Starprnt_Output_Adapter.php',
